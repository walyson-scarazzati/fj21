...
<c:import url="/WEB-INF/cabecalho.jsp"/>
	...
	<form action="mvc" method="post">
		Id: <input type="text" name="id" class="form-control input-sm chat-input"/><br/>
		Nome: <input type="text" name="nome" class="form-control input-sm chat-input"/><br/>
		E-mail: <input type="text" name="email" class="form-control input-sm chat-input"/><br/>
		Endereço: <input type="text" name="endereco" class="form-control input-sm chat-input"/><br/>
